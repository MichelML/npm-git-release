...
var G__1086 = new cljs.core.PersistentArrayMap(null, 5, [new cljs.core.Keyword(null,"report-counters","report-counters",-1702609242),new cljs.core.PersistentArrayMap(null, 4, [new cljs.core.Keyword(null,"test","test",577538877),(0),new cljs.core.Keyword(null,"pass","pass",1574159993),(0),new cljs.core.Keyword(null,"fail","fail",1706214930),(0),new cljs.core.Keyword(null,"error","error",-978969032),(0)], null),new cljs.core.Keyword(null,"testing-vars","testing-vars",-2114769150),cljs.core.List.EMPTY,new cljs.core.Keyword(null,"testing-contexts","testing-contexts",-1485646523),cljs.core.List.EMPTY,new cljs.core.Keyword(null,"formatter","formatter",-483008823),cljs.core.pr_str,new cljs.core.Keyword(null,"reporter","reporter",-805360621),reporter], null);
if(cljs.core._EQ_.call(null,new cljs.core.Keyword("cljs.test","pprint","cljs.test/pprint",1627393641),reporter)){
return cljs.core.assoc.call(null,G__1086,new cljs.core.Keyword(null,"reporter","reporter",-805360621),new cljs.core.Keyword("cljs.test","default","cljs.test/default",-1581405322),new cljs.core.Keyword(null,"formatter","formatter",-483008823),cljs.pprint.pprint);
} else {
return G__1086;
}
});
...
var or__3836__auto__ = cljs.test._STAR_current_env_STAR_;
...
var len__4411__auto___1091 = arguments.length;
var i__4412__auto___1092 = (0);
while(true){
if((i__4412__auto___1092 < len__4411__auto___1091)){
args__4414__auto__.push((arguments[i__4412__auto___1092]));

var G__1093 = (i__4412__auto___1092 + (1));
i__4412__auto___1092 = G__1093;
continue;
} else {
}
break;
...
return cljs.test.update_current_env_BANG_.cljs$core$IFn$_invoke$arity$variadic((arguments[(0)]),(arguments[(1)]),argseq__4415__auto__);
});
...
cljs.test.update_current_env_BANG_.cljs$lang$applyTo = (function (seq1088){
...
return cljs.test.update_current_env_BANG_.cljs$core$IFn$_invoke$arity$variadic(G__1089,G__1090,seq1088__$2);
});
...
var file = cljs.core.get.call(null,map__1095__$1,new cljs.core.Keyword(null,"file","file",-1269645878));
var line = cljs.core.get.call(null,map__1095__$1,new cljs.core.Keyword(null,"line","line",212345235));
var column = cljs.core.get.call(null,map__1095__$1,new cljs.core.Keyword(null,"column","column",2078222095));
return [cljs.core.str.cljs$core$IFn$_invoke$arity$1(cljs.core.reverse.call(null,cljs.core.map.call(null,((function (map__1095,map__1095__$1,file,line,column){
return (function (p1__1094_SHARP_){
return new cljs.core.Keyword(null,"name","name",1843675177).cljs$core$IFn$_invoke$arity$1(cljs.core.meta.call(null,p1__1094_SHARP_));
});})(map__1095,map__1095__$1,file,line,column))
 ...
 */
cljs.test.report = (function (){var method_table__4297__auto__ = cljs.core.atom.call(null,cljs.core.PersistentArrayMap.EMPTY);
...
return (new cljs.core.MultiFn(cljs.core.symbol.call(null,"cljs.test","report"),((function (method_table__4297__auto__,prefer_table__4298__auto__,method_cache__4299__auto__,cached_hierarchy__4300__auto__,hierarchy__4301__auto__){
return (function (m){
...
var formatter_fn = (function (){var or__3836__auto__ = new cljs.core.Keyword(null,"formatter","formatter",-483008823).cljs$core$IFn$_invoke$arity$1(cljs.test.get_current_env.call(null));
if(cljs.core.truth_(or__3836__auto__)){
return or__3836__auto__;
} else {
...
var temp__4657__auto___1097 = new cljs.core.Keyword(null,"message","message",-406056002).cljs$core$IFn$_invoke$arity$1(m);
if(cljs.core.truth_(temp__4657__auto___1097)){
var message_1098 = temp__4657__auto___1097;
cljs.core.println.call(null,message_1098);
} else {
}
...
var temp__4657__auto___1099 = new cljs.core.Keyword(null,"message","message",-406056002).cljs$core$IFn$_invoke$arity$1(m);
if(cljs.core.truth_(temp__4657__auto___1099)){
var message_1100 = temp__4657__auto___1099;
cljs.core.println.call(null,message_1100);
} else {
}
...
var output_dir = "out";
var output_dir__$1 = (function (){var G__1101 = output_dir;
if(!(clojure.string.ends_with_QMARK_.call(null,output_dir,"/"))){
return [cljs.core.str.cljs$core$IFn$_invoke$arity$1(G__1101),"/"].join('');
} else {
return G__1101;
}
})();
...
var temp__4655__auto__ = (function (){var and__3828__auto__ = typeof exception.stack === 'string';
if(and__3828__auto__){
var G__1103 = exception.stack;
var G__1103__$1 = (((G__1103 == null))?null:clojure.string.split_lines.call(null,G__1103));
var G__1103__$2 = (((G__1103__$1 == null))?null:cljs.core.get.call(null,G__1103__$1,depth));
if((G__1103__$2 == null)){
return null;
} else {
return clojure.string.trim.call(null,G__1103__$2);
}
} else {
...
var vec__1104 = cljs.test.js_line_and_column.call(null,stack_element);
var line = cljs.core.nth.call(null,vec__1104,(0),null);
var column = cljs.core.nth.call(null,vec__1104,(1),null);
var vec__1107 = cljs.test.mapped_line_and_column.call(null,fname,line,column);
var fname__$1 = cljs.core.nth.call(null,vec__1107,(0),null);
var line__$1 = cljs.core.nth.call(null,vec__1107,(1),null);
var column__$1 = cljs.core.nth.call(null,vec__1107,(2),null);
...
var m__$1 = (function (){var G__1110 = new cljs.core.Keyword(null,"type","type",1174270348).cljs$core$IFn$_invoke$arity$1(m);
...
var G__1114 = (function (){var G__1113 = cljs.core.rest.call(null,fns);
...
return cljs.core.concat.call(null,obj,G__1113);
} else {
return G__1113;
}
})();
...
return cljs.core.vary_meta.call(null,G__1115,cljs.core.assoc,new cljs.core.Keyword("cljs.test","block?","cljs.test/block?",686379965),true);
}
});
...
}catch (e1116){var e = e1116;
var G__1117 = e;
var G__1117__$1 = (((G__1117 instanceof cljs.core.Keyword))?G__1117.fqn:null);
switch (G__1117__$1) {
...
var vec__1119 = fixtures_types.call(null);
var type = cljs.core.nth.call(null,vec__1119,(0),null);
var types = vec__1119;
...
return cljs.core.map.call(null,(function (p__1122){
var vec__1123 = p__1122;
var ns = cljs.core.nth.call(null,vec__1123,(0),null);
var vars__$1 = cljs.core.nth.call(null,vec__1123,(1),null);
return ((function (vec__1123,ns,vars__$1){
return (function (){
...
var G__1126 = cljs.test.execution_strategy.call(null,once_fixtures,each_fixtures);
var G__1126__$1 = (((G__1126 instanceof cljs.core.Keyword))?G__1126.fqn:null);
switch (G__1126__$1) {
case "async":
...
return new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [((function (each_fixture_fn,G__1126,G__1126__$1,env,once_fixtures,each_fixtures,vec__1123,ns,vars__$1){
return (function (){
return cljs.test.join_fixtures.call(null,once_fixtures).call(null,((function (each_fixture_fn,G__1126,G__1126__$1,env,once_fixtures,each_fixtures,vec__1123,ns,vars__$1){
return (function (){
var seq__1127 = cljs.core.seq.call(null,vars__$1);
var chunk__1128 = null;
var count__1129 = (0);
var i__1130 = (0);
while(true){
if((i__1130 < count__1129)){
var v = cljs.core._nth.call(null,chunk__1128,i__1130);
var temp__4657__auto___1132 = new cljs.core.Keyword(null,"test","test",577538877).cljs$core$IFn$_invoke$arity$1(cljs.core.meta.call(null,v));
if(cljs.core.truth_(temp__4657__auto___1132)){
var t_1133 = temp__4657__auto___1132;
each_fixture_fn.call(null,((function (seq__1127,chunk__1128,count__1129,i__1130,t_1133,temp__4657__auto___1132,v,each_fixture_fn,G__1126,G__1126__$1,env,once_fixtures,each_fixtures,vec__1123,ns,vars__$1){
return (function (){
return cljs.test.run_block.call(null,cljs.test.test_var_block_STAR_.call(null,v,cljs.test.disable_async.call(null,t_1133)));
});})(seq__1127,chunk__1128,count__1129,i__1130,t_1133,temp__4657__auto___1132,v,each_fixture_fn,G__1126,G__1126__$1,env,once_fixtures,each_fixtures,vec__1123,ns,vars__$1))
);
} else {
}

var G__1134 = seq__1127;
var G__1135 = chunk__1128;
var G__1136 = count__1129;
var G__1137 = (i__1130 + (1));
seq__1127 = G__1134;
chunk__1128 = G__1135;
count__1129 = G__1136;
i__1130 = G__1137;
...
var temp__4657__auto__ = cljs.core.seq.call(null,seq__1127);
if(temp__4657__auto__){
var seq__1127__$1 = temp__4657__auto__;
if(cljs.core.chunked_seq_QMARK_.call(null,seq__1127__$1)){
var c__4231__auto__ = cljs.core.chunk_first.call(null,seq__1127__$1);
var G__1138 = cljs.core.chunk_rest.call(null,seq__1127__$1);
var G__1139 = c__4231__auto__;
var G__1140 = cljs.core.count.call(null,c__4231__auto__);
var G__1141 = (0);
seq__1127 = G__1138;
chunk__1128 = G__1139;
count__1129 = G__1140;
...
var v = cljs.core.first.call(null,seq__1127__$1);
var temp__4657__auto___1142__$1 = new cljs.core.Keyword(null,"test","test",577538877).cljs$core$IFn$_invoke$arity$1(cljs.core.meta.call(null,v));
if(cljs.core.truth_(temp__4657__auto___1142__$1)){
var t_1143 = temp__4657__auto___1142__$1;
each_fixture_fn.call(null,((function (seq__1127,chunk__1128,count__1129,i__1130,t_1143,temp__4657__auto___1142__$1,v,seq__1127__$1,temp__4657__auto__,each_fixture_fn,G__1126,G__1126__$1,env,once_fixtures,each_fixtures,vec__1123,ns,vars__$1){
return (function (){
return cljs.test.run_block.call(null,cljs.test.test_var_block_STAR_.call(null,v,cljs.test.disable_async.call(null,t_1143)));
});})(seq__1127,chunk__1128,count__1129,i__1130,t_1143,temp__4657__auto___1142__$1,v,seq__1127__$1,temp__4657__auto__,each_fixture_fn,G__1126,G__1126__$1,env,once_fixtures,each_fixtures,vec__1123,ns,vars__$1))
);
} else {
}

var G__1144 = cljs.core.next.call(null,seq__1127__$1);
var G__1145 = null;
var G__1146 = (0);
var G__1147 = (0);
seq__1127 = G__1144;
...
});})(each_fixture_fn,G__1126,G__1126__$1,env,once_fixtures,each_fixtures,vec__1123,ns,vars__$1))
);
});})(each_fixture_fn,G__1126,G__1126__$1,env,once_fixtures,each_fixtures,vec__1123,ns,vars__$1))
], null);
...
break;
default:
throw (new Error(["No matching clause: ",cljs.core.str.cljs$core$IFn$_invoke$arity$1(G__1126__$1)].join('')));

}
})());
});
;})(vec__1123,ns,vars__$1))
